...
public:
//  TwoWire *_i2c;
	uint8_t _i2c_bus = I2C_BUS_1; // I2C bus number, e.g., 1 or 2
	uint8_t _addr = ICM_20948_I2C_ADDR_AD0;
	uint8_t _ad0;
	bool _ad0val;
	ICM_20948_Serif_t _serif;
	...
	virtual ICM_20948_Status_e begin(uint8_t i2c_bus = I2C_BUS_1, uint8_t addr = ICM_20948_I2C_ADDR_AD0);
